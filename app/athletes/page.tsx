...
const FORM_STEPS = [
  {
    ...
    fields: [
      ...
      { id: 'sport', label: 'Sport',     type: 'text',  placeholder: 'e.g. Soccer, Basketball, Track...' },
    ],
  },
  {
    step: 2,
    ...
    fields: [
      { id: 'level', label: 'Competition level', type: 'select',
        options: ['Youth / Amateur','High School','Collegiate','Semi-Professional','Professional','Retired Pro'] },
      { id: 'location',  label: 'City / Country',   type: 'text', placeholder: 'e.g. Los Angeles, CA' },
      { id: 'instagram', label: 'Instagram handle', type: 'text', placeholder: '@handle' },
    ],
  },
  {
    step: 3,
    ...
    fields: [
      { id: 'goals', label: "What are you looking for?", type: 'multicheck',
        options: ['Brand partnerships','Community & networking','Athlink profile','HERO documentary','Teams Elevated','Mentorship'] },
      { id: 'message', label: "Anything else you want us to know?", type: 'textarea', placeholder: 'Optional...' },
    ],
  },
];
    ...
    <div className={`${barlow.variable} ${montserrat.variable} font-(family-name:--font-montserrat) bg-white text-[#092866] overflow-x-hidden`}>
      ...
      <section className="px-6 py-32 md:px-12 lg:px-20">
        ...
        <div className="space-y-0 border-t border-[#092866]/8">
          {[
            {n:'01', tag:'Athlete First', title:'The human behind the result', body:'We show up for you beyond the highlight reel — for the grind, the setbacks, the comeback, and everything in between.'},
            {n:'02', tag:'Performance + Purpose', title:'More than a score', body:'Your success is even sweeter when it lifts others. We tie what you do on the field to something that lasts.'},
            {n:'03', tag:'Community', title:'Stronger together', body:'The best athletes are made by strong communities. We connect you to the people and tools that help both grow.'},
          ].map((v,i)=>(
            <div key={v.n}
      ...
      <section id="hero-doc" className="overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="sr relative flex flex-col justify-center bg-white px-8 py-20 md:px-12" style={{transitionDelay:'130ms'}}>
            <div className="mb-8 text-[10px] font-semibold uppercase tracking-[0.34em] text-[#52aafc]">Already filmed</div>
                ...
                <div key={a.name} className="filmed-row group py-7 last:border-b-0">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="text-right">
                      <span className="block text-[10px] font-semibold uppercase tracking-[0.18em] text-[#092866]/30">{a.sport}</span>
                      <span className="filmed-cta block text-[10px] font-semibold uppercase tracking-[0.18em] text-[#52aafc]">Filmed ✓</span>
                    </div>
                  </div>
                </div>
              ))}
